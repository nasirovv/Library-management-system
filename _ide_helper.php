...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function upload($image, $catalog, $id)
        {
                        /** @var \App\Http\Services\ImageService $instance */
                        return $instance->upload($image, $catalog, $id);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function update($image, $catalog, $id)
        {
                        /** @var \App\Http\Services\ImageService $instance */
                        return $instance->update($image, $catalog, $id);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function get($catalog, $id)
        {
                        /** @var \App\Http\Services\ImageService $instance */
...
namespace  { 
            ...
            class Image extends \App\Facades\Image {}
